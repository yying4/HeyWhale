...
def read_image(filename, resize_height=None, resize_width=None, normalization=False):
    ...
    if normalization:  # 不能写成:rgb_image=rgb_image/255
...
def show_image_rect(win_name, image, rect):
    ...
    '''
    # x, y, w, h = rect
    x, y, w, h = [3866, 3084, 434, 362]
    point1 = (x, y)
    point2 = (x + w, y + h)
    cv2.rectangle(image, point1, point2, (0, 0, 255), thickness=12)
    x, y, w, h = [3462, 2765, 1223, 1023]
    point1 = (x, y)
    point2 = (x + w, y + h)
    cv2.rectangle(image, point1, point2, (255, 0, 0), thickness=12)
...
if __name__ == "__main__":
    ...
    dest_image = resize_image(image, resize_height=400, resize_width=400)
