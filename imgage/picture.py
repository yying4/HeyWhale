...
def on_mouse(event, x, y, flags, param):
 ...
 elif event == cv2.EVENT_FLAG_LBUTTON and (flags & cv2.EVENT_FLAG_LBUTTON): # 按住左键拖曳，画框
...
def select_user_roi(image_path):
 ...
 resize_image = image_processing.resize_image(orig_image, resize_height=400, resize_width=None)
